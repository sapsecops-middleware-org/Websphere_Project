...
```
psql -h localhost -U digistack_app -d digistack_bank -c "SELECT id, username FROM users;"
```
#### Verification-2
...
```
psql -h localhost -U digistack_app -d digistack_bank -c "INSERT INTO accounts (user_id, account_number, balance) VALUES (9999, 'DSB-ACC-BAD', 100.00);"
```
...
```
psql -h localhost -U digistack_app -d digistack_bank -c "\dt"
```
Expected output:
```
app_config
